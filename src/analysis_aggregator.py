...
from src.config import (
    ...
    DEFAULT_RANK_TREND_LOOKBACK # <<< Adiciona lookback padrão
)
...
# <<< Importa a nova análise de rank >>>
...
def get_consolidated_analysis(concurso_maximo: int) -> Optional[Dict[str, Any]]:
    """ Executa análises V8 (inclui group stats e rank trend). """
    ...
    if cycles_df_until_max is not None and not cycles_df_until_max.empty:
        ...
        closing_stats_df = calculate_closing_number_stats(cycles_df_until_max) # Passa o DF completo
